        ...
        <TableBody>
          {users.map(user => (
            <StyledTableRow key={user._id}>
              <StyledTableCell component="th" scope="row">0-10</StyledTableCell>
              <StyledTableCell align="left">{user.nickname}</StyledTableCell>
              <StyledTableCell align="right">{user.games_played}</StyledTableCell>
              <StyledTableCell align="right">{user.games_won}</StyledTableCell>
              <StyledTableCell align="right">{user.games_lost}</StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
        </Table>
